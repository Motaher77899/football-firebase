...
//             TeamsTab(tournamentId: widget.tournamentId, tournamentName: '',),
//           ],
//         ),
//       ),
//     );
...
class _TournamentDetailsScreenState extends State<TournamentDetailsScreen>
  ...
  Future<void> _loadTournament() async {
    try {
      ...
      if (doc.exists) {
        setState(() {
          _tournament = Tournament.fromMap(doc.data()!, doc.id);
          _isLoading = false;
        });
      } else {
        setState(() {
        ...
        body: NestedScrollView(
          ...
          body: TabBarView(
            children: [
              ...
              TeamsTab(
                tournamentId: widget.tournamentId,
                tournamentName: _tournament!.name, // ✅ Added
              ),
          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  '${DateFormat('dd MMM yyyy').format(_tournament!.startDate)} - ${DateFormat('dd MMM yyyy').format(_tournament!.endDate)}',
                  style: const TextStyle(
                    color: Colors.white70,
                    fontSize: 13,
                  ),
...
// ============================================================================
// SLIVER APP BAR DELEGATE (for pinned TabBar)
// ============================================================================
class _SliverAppBarDelegate extends SliverPersistentHeaderDelegate {
  final TabBar _tabBar;
