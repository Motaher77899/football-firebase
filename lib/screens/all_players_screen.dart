...
class _AllPlayersScreenState extends State<AllPlayersScreen> {
  ...
  Widget _buildPlayerCard(BuildContext context, PlayerModel player) {
    // ✅ Determine which photo URL to use (priority: profilePhotoUrl > imageUrl)
    final String photoUrl = player.profilePhotoUrl?.isNotEmpty == true
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              // ✅ খেলোয়াড়ের ছবি (CachedNetworkImage দিয়ে)
              Container(
                width: 70,
                height: 70,
                decoration: BoxDecoration(
                ...
                child: ClipOval(
                  child: photoUrl.isNotEmpty
                    ...
                    errorWidget: (context, url, error) {
                      debugPrint('❌ Error loading photo: $photoUrl');
                      return Center(
                        child: Text(
